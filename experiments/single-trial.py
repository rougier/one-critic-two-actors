...
ctx, thl, gpi, stn, str, i0, i1 = simulate(task, model, "cog", 1)
plot_freq(ax, ctx, thl, gpi, stn, str, i0, i1, duration, dt,
          "B Cognitive channel (no cortical competition)", 0, 0)
plot_raster(ax, ctx, thl, gpi, stn, str, i0, i1, duration, dt, "")
...
ctx, thl, gpi, stn, str, i0, i1 = simulate(task, model, "cog", 1)
plot_freq(ax, ctx, thl, gpi, stn, str, i0, i1, duration, dt,
          "F Cognitive channel", 1, 0)
plot_raster(ax, ctx, thl, gpi, stn, str, i0, i1, duration, dt, "")

ax = plt.subplot(3,2,3)
ctx, thl, gpi, stn, str, i0, i1 = simulate(task, model, "mot", 0)
plot_freq(ax, ctx, thl, gpi, stn, str, i0, i1, duration, dt,
          "C Motor channel (no basal competition)", 0, 1)
plot_raster(ax, ctx, thl, gpi, stn, str, i0, i1, duration, dt, "")

ax = plt.subplot(3,2,4)
ctx, thl, gpi, stn, str, i0, i1 = simulate(task, model, "cog", 0)
plot_freq(ax, ctx, thl, gpi, stn, str, i0, i1, duration, dt,
          "D Cognitive channel (no basal competition)", 0, 0)
plot_raster(ax, ctx, thl, gpi, stn, str, i0, i1, duration, dt, "")


plt.tight_layout()
plt.savefig("single-trial.pdf")
plt.show()
